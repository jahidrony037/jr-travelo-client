      ...
      <div className="navbar bg-base-100 sticky top-0 shadow-sm z-10">
        ...
        <div className="navbar-end gap-4">
          ...
          {!user ? (
            <Link
              to="/login"
              className="px-5 py-2 relative rounded  group overflow-hidden font-medium bg-[#1ec6b6] text-white inline-block border-[1px] "
            >
              <span className="absolute top-0 left-0 flex w-full h-0 mb-0 transition-all duration-200 ease-out transform translate-y-0 bg-[#ff4a52]  group-hover:h-full opacity-90 group-hover:border-[#ff4a52]"></span>
              <span className="relative group-hover:text-white font-bold">
                Login
              </span>
            </Link>
